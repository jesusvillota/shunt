...
| `usage_refresh_seconds` | 비활성(`0`/미설정) | Claude `GET /api/oauth/usage`, Codex `GET /wham/usage`, Antigravity `POST :retrieveUserQuota`의 폴링 간격(초); 60 미만의 양수 값은 60초 하한으로 올림 |
